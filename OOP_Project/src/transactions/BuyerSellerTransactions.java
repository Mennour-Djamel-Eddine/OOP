...
public class BuyerSellerTransactions extends Transactions {

    public static List<BuyerSellerTransactions> transactionsList = new ArrayList<>();

    public BuyerSellerTransactions(String clientName, int clientID, int propertyID, int bankAccountID) {
    ...
    public static void addTransaction(String clientName, int clientID, int propertyID, int bankAccountID) {
        transactionsList.add(new BuyerSellerTransactions(clientName, clientID, propertyID, bankAccountID));
    }
